<?php 
    class Mahasiswa extends CI_Controller{
        ...
        public function tambah(){
            $this->load->view('templates/header');
            $this->load->view('templates/sidebar');$this->load->view('mahasiswa');$this->load->view('templates/footer');
        }
        ...
        public function pdf(){
            ...
            $data['mahasiswa'] = $this->m_mahasiswa->tampil_data('tb_mahasiswaa')->result;
